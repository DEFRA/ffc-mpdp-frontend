...
// describe('Validation and redirect behavior for missing or blank searchString on /results', () => {
//   test('returns 400 and calls resultsModel when searchString is missing', async () => {
//     const response = await global.__SERVER__.inject({
//       method: 'GET',
//       url: '/results?pageId=index'
//     })

//     expect(response.statusCode).toBe(400)
//     expect(response.payload).toContain('search/index')
//   })

//   test('returns 400 with resultsModel when searchString is blank', async () => {
//     const response = await global.__SERVER__.inject({
//       method: 'GET',
//       url: '/results?searchString=   &pageId=search'
//     })

//     expect(response.statusCode).toBe(400)
//     expect(response.payload).toContain('search/search')
//   })

//   test('returns 400 with errorList if other validation error occurs', async () => {
//     const response = await global.__SERVER__.inject({
//       method: 'GET',
//       url: '/results?searchString=test&someInvalidField=bad'
//     })

//     expect(response.statusCode).toBe(400)
//     expect(response.payload).toContain('errorList')
//   })

//   test('redirects to /search if searchString is missing in handler', async () => {
//     const response = await global.__SERVER__.inject({
//       method: 'GET',
//       url: '/results'
//     })
...
//   test('redirects to /search if searchString is blank in handler', async () => {
//     const response = await global.__SERVER__.inject({
//       method: 'GET',
...
//   test('renders results view with encoded searchString', async () => {
//     const response = await global.__SERVER__.inject({
//       method: 'GET',
//       url: '/results?searchString=hello world'
//     })

//     expect(response.statusCode).toBe(200)
//     expect(response.payload).toContain('search/results')
//   })
// })
